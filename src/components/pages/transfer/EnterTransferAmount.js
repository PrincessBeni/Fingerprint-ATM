...
<div className = 'enter-amount-container'>
            <div className = 'enter-transfer-amount-pic-and-text'>
           <div className = 'enter-transfer-amount-text'>
                <h1>Please enter amount to transfer</h1>
                
            </div>
            <img src='cancel button.png'
                    onClick = {() => window.location = '/Transfer'}  
                    alt='Cancel selection. Go back to previous page'
                    className='enter-transfer-amount-cancel-pic'
                />
            </div>
            ...
            <div className = 'pin-proceed-confirmation-btn'>
                {button && <Button onClick = {() => window.location.href = '/ConfirmTransfer'}
